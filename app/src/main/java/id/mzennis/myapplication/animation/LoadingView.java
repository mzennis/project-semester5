package id.mzennis.myapplication.animation;
...
import id.mzennis.myapplication.animation.render.LoadingDrawable;
import id.mzennis.myapplication.animation.render.LoadingRenderer;
import id.mzennis.myapplication.animation.render.LoadingRendererFactory;
